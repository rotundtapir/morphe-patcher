        ...
        try {
            ...
            encoder.apkModule.use { loadedModule ->
                ...
                ApkModule.loadApkFile(apkFile).use { originalModule ->
                    ...
                    // Placeholders that were never read are taken from the original archive even
                    // when the snapshot diff would rebuild them (package rename).
                    val pendingModule = reusePendingOriginalEntries(loadedModule)
                    try {
